...
# Answer =>
# Keeps code DRY
# Allows for more organized & easy to read code
# Allows for more flexibility

# Creating objets allows programmers to think more abstractly about the code they are writing.
# Objects are represented by nouns so they are easier to conceptualize.
# It allows us to only expose funtionality to the parts of code that need it, meaning namespace issues are much harder to come across.
# It allows us to easily give functionality to different parts of an application without duplication.
# We can build applications fast as we can reuse pre-written code.
